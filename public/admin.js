...
async function checkAdmin() {
  /*
   * Telegram уже ждём в boot().
   * Здесь дополнительно проверяем,
   * что initData действительно получен.
   */
  ...
  /*
   * Если initData нет —
   * это не полноценный Telegram Mini App.
   */
...
async function boot() {
  try {
    /*
     * Сначала показываем экран проверки.
     */
     ...
     * АВТОРИЗАЦИЯ УСПЕШНА.
     *
     * Именно здесь убираем бесконечный
     * экран "Проверяем доступ..."
     * и показываем adminScreen.
     * ==========================================
     */
    ...
    /*
     * Если админка была открыта
     * кнопкой "Открыть заказ"
     * из Telegram — сразу открываем
     * нужный заказ.
     */
