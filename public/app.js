  ...
  async function placeOrder() {
    ...
    try {
      ...
      */
      ...
      /* Открываем именно созданный заказ, а не список заказов. */
      const firstCreated = created[0];

      if (!firstCreated?.id) {
        throw new Error("Заказ создан, но сервер не вернул его ID");
      }
        ...
        ${
          ...
          "pending_payment"
            ...
            : order.reservation_status ===
              ...
              ? `
                <div class="info-box">
                  <strong>🟠 Ожидайте проверки залога</strong>
                  <div style="margin-top:6px">
                    Мы получили информацию об оплате.
                    Администратор проверит перевод.
                    После подтверждения вы получите уведомление от бота.
                  </div>
                </div>
              `
              : order.reservation_status ===
