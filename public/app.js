      ...
      <div class="screen">
        ...
        <div class="order-card" style="padding:20px;margin-bottom:12px">
          ...
          <div class="summary" style="margin-top:16px">
            ...
            <div class="summary-row"><span>Телефон</span><strong>${escapeHtml(user.phone || "Не добавлен")}</strong></div>
          </div>

          <div style="display:flex;gap:8px;margin-top:14px">
            <input id="profilePhone" class="checkout-input" type="tel" inputmode="tel" autocomplete="tel" placeholder="Ваш номер телефона" value="${escapeHtml(user.phone || "")}" style="flex:1">
