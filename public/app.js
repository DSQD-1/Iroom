...
(() => {
  ...
  async function placeOrder() {
    ...
    try {
      ...
      /* После создания заказа НЕ отправляем reservation-paid автоматически.
       * Пользователь должен увидеть страницу конкретного заказа,
       * прочитать реквизиты и только там нажать «Я внёс залог».
       */
