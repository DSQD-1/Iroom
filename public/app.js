  ...
  function checkoutStepReservation(
    ...
    return `
      <div class="reservation-card">
        ...
        <div class="info-box">
          Сначала создайте заказ. После создания
          вы попадёте на его страницу, где сможете
          перевести залог и нажать «Я внёс залог».
  ...
  async function placeOrder() {
    ...
    try {
      ...
      */
      ...
      // После создания не отправляем пользователя
      // просто в список заказов: открываем созданный заказ.
      // Для корзины из нескольких товаров открываем первый созданный.
      ...
      if (firstCreated?.id) {
        ...
        setTimeout(() => {
          toast(
            "Заказ создан. Теперь оплатите залог и нажмите «Я внёс залог»."
          );
        }, 50);
      } else {
        state.route =
            ...
            ? `
              <div class="info-box">
                ...
                <div style="margin-top:6px">
                  Переведите залог по реквизитам ниже.
                  После перевода нажмите «Я внёс залог».
                </div>
              </div>
              ${reservationPaymentBlock(order)}
            `
            : order.reservation_status ===
              "awaiting_confirmation"
              ? `
