...
/*
  Полное название товара для сообщений.
...
/*
  ...
  а если его нет — обычную ссылку.
*/

function openTelegramMessage(text) {
  const username = getContactUsername();
  ...
  if (!username) {
    ...
    console.error(
      "CONTACT USERNAME отсутствует в /api/settings:",
      settings
    );
...
/*
  ...
  Пример:
  Здравствуйте! Хочу забронировать iPhone 17 Pro Max 512gb Orange eSIM - 100.000
*/
...
function bookProduct() {
  ...
  const productName =
    getFullProductName(currentProduct);
...
/*
  ...
  Пример:
  Здравствуйте! Хочу проконсультироваться по поводу iPhone 17 Pro Max 512gb Orange eSIM.
*/
