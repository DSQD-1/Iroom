...
function renderPopularProducts() {
  ...
  const source =
    [...products]
      .sort(
        (a, b) =>
          Number(b.sales || b.orders_count || 0) -
          Number(a.sales || a.orders_count || 0)
      )
      .slice(0, 8);
...
function renderCheckout() {
  ...
  container.innerHTML = `
    ...
    <div class="checkout-card">
      ...
      <div style="margin-top:10px;color:#777;font-size:11px;line-height:1.5">
    ...
    <div class="checkout-card reservation-box">
      ...
      <div style="margin-top:6px;color:#888;font-size:12px;line-height:1.5">
...
function renderCheckoutAddress(type) {
  ...
  container.innerHTML = `
    <div style="
      ...
      line-height:1.5;
    ">
      Самовывоз из магазина IRoom.<br>
      Точный адрес и время работы
      подтверждает менеджер после оформления заказа.
    </div>
  `;
}
...
function renderProfile() {
  ...
  if (!currentUser) {
    if (name) name.textContent = "Покупатель";
    if (username) username.textContent = "Telegram";
    return;
  }
