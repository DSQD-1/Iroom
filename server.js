...
async function migrate() {
  ...
  // Products: migrate every column used by the current admin/API.
  await addColumnIfMissing("products", "category_id", "INTEGER");
  await addColumnIfMissing("products", "name", "TEXT DEFAULT ''");
  await addColumnIfMissing("products", "description", "TEXT DEFAULT ''");
  await addColumnIfMissing("products", "price", "REAL DEFAULT 0");
  await addColumnIfMissing("products", "old_price", "REAL DEFAULT 0");
  await addColumnIfMissing("products", "image_url", "TEXT DEFAULT ''");
  await addColumnIfMissing("products", "images", "TEXT DEFAULT '[]'");
  await addColumnIfMissing("products", "price_options", "TEXT DEFAULT '{}'" );
  ...
  // Product variants: older databases may also be missing newer fields.
  await addColumnIfMissing("product_variants", "product_id", "INTEGER");
  await addColumnIfMissing("product_variants", "name", "TEXT DEFAULT ''");
  await addColumnIfMissing("product_variants", "price", "REAL DEFAULT 0");
  await addColumnIfMissing("product_variants", "color", "TEXT DEFAULT ''");
  await addColumnIfMissing("product_variants", "memory", "TEXT DEFAULT ''");
  await addColumnIfMissing("product_variants", "sim_type", "TEXT DEFAULT ''");
  await addColumnIfMissing("product_variants", "region", "TEXT DEFAULT ''");
  await addColumnIfMissing("product_variants", "image_url", "TEXT DEFAULT ''");
