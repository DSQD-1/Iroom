...
app.put(
  ...
  async (req, res) => {
    try {
      ...
      /*
       * Если админ передал варианты,
       * полностью обновляем варианты товара.
       */
      if (
        Array.isArray(
          body.variants
 ...
 * /admin.html
 *
 * Сам HTML доступен как страница,
 * но все реальные admin API защищены requireAdmin.
 */
 ...
 *
 * Все неизвестные GET-запросы,
 * которые не являются API,
 * открывают обычный index.html.
 */
